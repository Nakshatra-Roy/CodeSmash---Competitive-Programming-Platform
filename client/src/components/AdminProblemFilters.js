...
const AdminProblemFilters = ({ onFilterChange, allDifficulties = [], allTags = [], filters }) => {
  ...
  const handleShowPending = () => {
    ...
    toast.success("Showing Problems Pending for Approval");
  };

  const handleShowRejected = () => {
    onFilterChange({ showRejected: true });
    toast.success("Showing Rejected Problems.");
  };
...
export default AdminProblemFilters;