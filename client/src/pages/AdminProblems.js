...
import AdminProblemFilters from "../components/AdminProblemFilters";
...
const AdminProblems = () => {
  ...
  return problems.filter((p) => {
    if (filters.showPending && p.status !== "Pending") return false;
    if (filters.showRejected && p.status !== "Rejected") return false;
    const matchSearch =
      !s ||
